...
import { Search, Briefcase, TrendingUp, Monitor, Code, Building2, Users, ArrowRight, Facebook, Twitter, Instagram, Linkedin, Globe } from 'lucide-react';
import { 
  MapPin, 
  Megaphone, 
  Wallet, 
...
import pic from './3.1 Dashboard Company.png'
import picintel from './intel-3.png'
import picamd from './amd-logo-1.png'
import pictalkit from './talkit 1.png'
import picvodafone from './vodafone-2017-logo.png'
import pictesla from './tesla-9 1.png'
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-3 md:flex md:justify-between items-center gap-4">
          <img src={picvodafone} alt="Vodafone" className="h-6 md:h-8" />
          <img src={picintel} alt="Intel" className="h-6 md:h-8" />
          <img src={pictesla} alt="Tesla" className="h-6 md:h-8" />
          <img src={picamd} alt="AMD" className="h-6 md:h-8 hidden md:block" />
          <img src={pictalkit} alt="Talkfit" className="h-6 md:h-8 hidden md:block" />
        </div>
      </section>
